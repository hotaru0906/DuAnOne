    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        else if (other.CompareTag("Boss"))
        {
            ...
            if (boss1 != null)
            {
                ...
                Debug.Log("Boss1 hit by Skill1 Ground, dealt " + playerSkill.skill1Damage + " damage.");
                return;
            }
            ...
            if (boss2 != null)
            {
                ...
                Debug.Log("Boss2 hit by Skill1 Ground, dealt " + playerSkill.skill1Damage + " damage.");
                return;
            }
            ...
            if (boss3 != null)
            {
                ...
                Debug.Log("Boss3 hit by Skill1 Ground, dealt " + playerSkill.skill1Damage + " damage.");
                return;
            }
            ...
            if (boss4 != null)
            {
                ...
                Debug.Log("Boss4 hit by Skill1 Ground, dealt " + playerSkill.skill1Damage + " damage.");
                return;
            }
            MiniBoss1 mb1 = other.GetComponent<MiniBoss1>();
            if (mb1 != null)
            {
                mb1.TakeDamage(playerSkill.skill1Damage);
                Debug.Log("MiniBoss1 hit by Skill1 Ground, dealt " + playerSkill.skill1Damage + " damage.");
                return;
            }
        }
    }
